...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/scsi/scsi_common.h: line 18 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/scsi/scsi_common.h: line 28 \n"); 
