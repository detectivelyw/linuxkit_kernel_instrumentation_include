...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/asm-generic/atomic-long.h: line 107 \n"); 
	ATOMIC_LONG_PFX(_t) *v = (ATOMIC_LONG_PFX(_t) *)l;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/asm-generic/atomic-long.h: line 196 \n"); 
	ATOMIC_LONG_PFX(_t) *v = (ATOMIC_LONG_PFX(_t) *)l;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/asm-generic/atomic-long.h: line 204 \n"); 
	ATOMIC_LONG_PFX(_t) *v = (ATOMIC_LONG_PFX(_t) *)l;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/asm-generic/atomic-long.h: line 212 \n"); 
	ATOMIC_LONG_PFX(_t) *v = (ATOMIC_LONG_PFX(_t) *)l;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/asm-generic/atomic-long.h: line 220 \n"); 
	ATOMIC_LONG_PFX(_t) *v = (ATOMIC_LONG_PFX(_t) *)l;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/asm-generic/atomic-long.h: line 247 \n"); 
	ATOMIC_LONG_PFX(_t) *v = (ATOMIC_LONG_PFX(_t) *)l;
