...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 208 \n"); 
	return inb_p(port);
}

static inline void vga_io_w (unsigned short port, unsigned char val)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 214 \n"); 
	outb_p(val, port);
}
...
static inline void vga_io_w_fast (unsigned short port, unsigned char reg,
				  unsigned char val)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 221 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 290 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 297 \n"); 
#ifdef VGA_OUTW_WRITE
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 345 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 352 \n"); 
#ifdef VGA_OUTW_WRITE
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 399 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 406 \n"); 
#ifdef VGA_OUTW_WRITE
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 450 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/video/vga.h: line 457 \n"); 
        vga_io_w (VGA_ATT_IW, reg);
