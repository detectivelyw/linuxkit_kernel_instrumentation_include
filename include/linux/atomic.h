...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 527 \n"); 
	atomic_and(~i, v);
}

static inline int atomic_fetch_andnot(int i, atomic_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 533 \n"); 
	return atomic_fetch_and(~i, v);
}

static inline int atomic_fetch_andnot_relaxed(int i, atomic_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 539 \n"); 
	return atomic_fetch_and_relaxed(~i, v);
}

static inline int atomic_fetch_andnot_acquire(int i, atomic_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 545 \n"); 
	return atomic_fetch_and_acquire(~i, v);
}

static inline int atomic_fetch_andnot_release(int i, atomic_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 551 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 1011 \n"); 
	atomic64_and(~i, v);
}

static inline long long atomic64_fetch_andnot(long long i, atomic64_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 1017 \n"); 
	return atomic64_fetch_and(~i, v);
}

static inline long long atomic64_fetch_andnot_relaxed(long long i, atomic64_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 1023 \n"); 
	return atomic64_fetch_and_relaxed(~i, v);
}

static inline long long atomic64_fetch_andnot_acquire(long long i, atomic64_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 1029 \n"); 
	return atomic64_fetch_and_acquire(~i, v);
}

static inline long long atomic64_fetch_andnot_release(long long i, atomic64_t *v)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/atomic.h: line 1035 \n"); 
