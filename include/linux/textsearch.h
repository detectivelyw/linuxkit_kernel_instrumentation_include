...
static inline unsigned int textsearch_next(struct ts_config *conf,
					   struct ts_state *state)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/textsearch.h: line 111 \n"); 
...
static inline unsigned int textsearch_find(struct ts_config *conf,
					   struct ts_state *state)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/textsearch.h: line 131 \n"); 
	state->offset = 0;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/textsearch.h: line 142 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/textsearch.h: line 152 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/textsearch.h: line 183 \n"); 
