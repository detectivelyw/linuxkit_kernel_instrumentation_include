...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/transport_class.h: line 85 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/transport_class.h: line 97 \n"); 
