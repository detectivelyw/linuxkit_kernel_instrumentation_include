...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/serio.h: line 138 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/serio.h: line 149 \n"); 
	return dev_get_drvdata(&serio->dev);
}

static inline void serio_set_drvdata(struct serio *serio, void *data)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/serio.h: line 155 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/serio.h: line 165 \n"); 
	spin_lock_irq(&serio->lock);
}

static inline void serio_continue_rx(struct serio *serio)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/serio.h: line 171 \n"); 
