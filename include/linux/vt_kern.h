...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/vt_kern.h: line 100 \n"); 
	return 0;
}
static inline
int con_set_unimap(struct vc_data *vc, ushort ct, struct unipair __user *list)
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/vt_kern.h: line 116 \n"); 
	return 0;
}
static inline void con_free_unimap(struct vc_data *vc)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/vt_kern.h: line 121 \n"); 
}
static inline void con_protect_unimap(struct vc_data *vc, int rdonly)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/vt_kern.h: line 125 \n"); 
}
static inline
int con_copy_unimap(struct vc_data *dst_vc, struct vc_data *src_vc)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/vt_kern.h: line 130 \n"); 
	return 0;
}
