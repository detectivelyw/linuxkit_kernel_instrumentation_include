...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 597 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 608 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 620 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 628 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 636 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 646 \n"); 
	if ((id[ATA_ID_COMMAND_SET_2] & 0xC000) != 0x4000)
		return false;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 654 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 668 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 681 \n"); 
	/* T13/1699-D Revision 6a, Sep 6, 2008. Page 128.
...
static inline u16 ata_id_logical_sector_offset(const u16 *id,
	 u8 log2_per_phys)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 703 \n"); 
	u16 word_209 = id[209];
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 725 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 735 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 750 \n"); 
	/* Yes children, word 83 valid bits cover word 82 data */
	if ((id[ATA_ID_COMMAND_SET_2] & 0xC000) != 0x4000)
		return false;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 759 \n"); 
	if ((id[ATA_ID_COMMAND_SET_2] & 0xC000) != 0x4000)
		return false;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 767 \n"); 
	if ((id[ATA_ID_CSF_DEFAULT] & 0xC000) != 0x4000)
		return false;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 775 \n"); 
	if ((id[ATA_ID_CSF_DEFAULT] & 0xC000) != 0x4000)
		return false;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 783 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 801 \n"); 
	if (!(id[ATA_ID_CFS_ENABLE_2] & (1 << 15)))
		return false;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 809 \n"); 
	if (!(id[ATA_ID_CFS_ENABLE_2] & (1 << 15)))
		return false;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 829 \n"); 
	return id[ATA_ID_SCT_CMD_XPORT] & (1 << 5) ? true : false;
}

static inline bool ata_id_sct_features_ctrl(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 835 \n"); 
	return id[ATA_ID_SCT_CMD_XPORT] & (1 << 4) ? true : false;
}

static inline bool ata_id_sct_error_recovery_ctrl(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 841 \n"); 
	return id[ATA_ID_SCT_CMD_XPORT] & (1 << 3) ? true : false;
}

static inline bool ata_id_sct_write_same(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 847 \n"); 
	return id[ATA_ID_SCT_CMD_XPORT] & (1 << 2) ? true : false;
}

static inline bool ata_id_sct_long_sector_access(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 853 \n"); 
	return id[ATA_ID_SCT_CMD_XPORT] & (1 << 1) ? true : false;
}

static inline bool ata_id_sct_supported(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 859 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 904 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 915 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 933 \n"); 
	return (id[ATA_ID_CSF_DEFAULT] & 0xC100) == 0x4100;
}

static inline int ata_id_form_factor(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 939 \n"); 
	u16 val = id[168];
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 955 \n"); 
	u16 val = id[217];
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 969 \n"); 
	return id[ATA_ID_SATA_CAPABILITY_2] & BIT(6);
}

static inline bool ata_id_has_ncq_non_data(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 975 \n"); 
	return id[ATA_ID_SATA_CAPABILITY_2] & BIT(5);
}

static inline bool ata_id_has_trim(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 981 \n"); 
	if (ata_id_major_version(id) >= 7 &&
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 990 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1001 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1030 \n"); 
	return id[ATA_ID_ROT_SPEED] == 0x01;
}

static inline u8 ata_id_zoned_cap(const u16 *id)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1036 \n"); 
	return (id[ATA_ID_ADDITIONAL_SUPP] & 0x3);
}

static inline bool ata_id_pio_need_iordy(const u16 *id, const u8 pio)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1042 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1055 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1065 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1083 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1102 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1145 \n"); 
#ifdef __BIG_ENDIAN
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1166 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1173 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/ata.h: line 1180 \n"); 
