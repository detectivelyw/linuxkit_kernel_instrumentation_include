...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/attribute_container.h: line 35 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/attribute_container.h: line 42 \n"); 
