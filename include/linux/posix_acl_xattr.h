...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/posix_acl_xattr.h: line 23 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/posix_acl_xattr.h: line 45 \n"); 
}
static inline void posix_acl_fix_xattr_to_user(void *value, size_t size)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/posix_acl_xattr.h: line 49 \n"); 
}
#endif
