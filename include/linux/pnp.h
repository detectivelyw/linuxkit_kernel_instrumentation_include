...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 36 \n"); 
	return NULL;
}
#endif
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 43 \n"); 
	if (res)
		return 1;
	return 0;
}
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 51 \n"); 
...
static inline resource_size_t pnp_port_end(struct pnp_dev *dev,
					   unsigned int bar)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 78 \n"); 
	struct resource *res = pnp_get_resource(dev, IORESOURCE_IO, bar);
...
static inline unsigned long pnp_port_flags(struct pnp_dev *dev,
					   unsigned int bar)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 89 \n"); 
	struct resource *res = pnp_get_resource(dev, IORESOURCE_IO, bar);
...
static inline resource_size_t pnp_mem_start(struct pnp_dev *dev,
					    unsigned int bar)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 116 \n"); 
...
static inline resource_size_t pnp_mem_end(struct pnp_dev *dev,
					  unsigned int bar)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 127 \n"); 
	struct resource *res = pnp_get_resource(dev, IORESOURCE_MEM, bar);
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 137 \n"); 
	struct resource *res = pnp_get_resource(dev, IORESOURCE_MEM, bar);
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 147 \n"); 
...
static inline resource_size_t pnp_mem_len(struct pnp_dev *dev,
					  unsigned int bar)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 154 \n"); 
	struct resource *res = pnp_get_resource(dev, IORESOURCE_MEM, bar);
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 189 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 199 \n"); 
	struct resource *res = pnp_get_resource(dev, IORESOURCE_DMA, bar);
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 209 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 253 \n"); 
	return pcard->driver_data;
}

static inline void pnp_set_card_drvdata(struct pnp_card_link *pcard, void *data)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 259 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 309 \n"); 
	return dev_get_drvdata(&pdev->dev);
}

static inline void pnp_set_drvdata(struct pnp_dev *pdev, void *data)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pnp.h: line 315 \n"); 
