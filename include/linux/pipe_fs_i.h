...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pipe_fs_i.h: line 125 \n"); 
...
static inline int pipe_buf_steal(struct pipe_inode_info *pipe,
				 struct pipe_buffer *buf)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/linux/pipe_fs_i.h: line 162 \n"); 
