...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/netfilter/nf_conntrack_acct.h: line 59 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/netfilter/nf_conntrack_acct.h: line 66 \n"); 
