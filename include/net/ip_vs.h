...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 42 \n"); 
	return net->ipvs;
}
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 51 \n"); 
#ifdef CONFIG_NET_NS
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 78 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 90 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 135 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 148 \n"); 
	int hdr_flags = 0;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 161 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 168 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 175 \n"); 
#ifdef CONFIG_IP_VS_IPV6
	if (af == AF_INET6)
		dst->in6 = src->in6;
	else
...
static inline void ip_vs_addr_set(int af, union nf_inet_addr *dst,
				  const union nf_inet_addr *src)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 187 \n"); 
#ifdef CONFIG_IP_VS_IPV6
	if (af == AF_INET6) {
		dst->in6 = src->in6;
		return;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 203 \n"); 
#ifdef CONFIG_IP_VS_IPV6
	if (af == AF_INET6)
...
static inline int sysctl_sync_threshold(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1082 \n"); 
	return DEFAULT_SYNC_THRESHOLD;
}

static inline int sysctl_sync_period(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1088 \n"); 
	return DEFAULT_SYNC_PERIOD;
}

static inline unsigned int sysctl_sync_refresh_period(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1094 \n"); 
	return DEFAULT_SYNC_REFRESH_PERIOD;
}

static inline int sysctl_sync_retries(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1100 \n"); 
	return DEFAULT_SYNC_RETRIES & 3;
}

static inline int sysctl_sync_ver(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1106 \n"); 
	return DEFAULT_SYNC_VER;
}

static inline int sysctl_sloppy_tcp(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1112 \n"); 
	return DEFAULT_SLOPPY_TCP;
}

static inline int sysctl_sloppy_sctp(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1118 \n"); 
	return DEFAULT_SLOPPY_SCTP;
}

static inline int sysctl_sync_ports(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1124 \n"); 
	return 1;
}

static inline int sysctl_sync_persist_mode(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1130 \n"); 
	return 0;
}

static inline unsigned long sysctl_sync_qlen_max(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1136 \n"); 
	return IPVS_SYNC_QLEN_MAX;
}

static inline int sysctl_sync_sock_size(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1142 \n"); 
	return 0;
}

static inline int sysctl_pmtu_disc(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1148 \n"); 
	return 1;
}

static inline int sysctl_backup_only(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1154 \n"); 
	return 0;
}

static inline int sysctl_conn_reuse_mode(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1160 \n"); 
	return 1;
}

static inline int sysctl_schedule_icmp(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1166 \n"); 
	return 0;
}

static inline int sysctl_ignore_tunneled(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1172 \n"); 
	return 0;
}

static inline int sysctl_cache_bypass(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1178 \n"); 
	return 0;
}
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1216 \n"); 
	p->ipvs = ipvs;
	p->af = af;
	p->protocol = protocol;
	p->caddr = caddr;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1247 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1254 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1277 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1314 \n"); 
	if (cp->control) {
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1450 \n"); 
	atomic_inc(&dest->refcnt);
}

static inline void ip_vs_dest_put(struct ip_vs_dest *dest)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1456 \n"); 
	smp_mb__before_atomic();
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1463 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1535 \n"); 
	char fwd;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1593 \n"); 
...
static inline int ip_vs_conntrack_enabled(struct netns_ipvs *ipvs)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1632 \n"); 
	return 0;
}
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1639 \n"); 
}

static inline int ip_vs_confirm_conntrack(struct sk_buff *skb)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1644 \n"); 
	return NF_ACCEPT;
}

static inline void ip_vs_conn_drop_conntrack(struct ip_vs_conn *cp)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1650 \n"); 
}
...
static inline bool ip_vs_conn_uses_conntrack(struct ip_vs_conn *cp,
					     struct sk_buff *skb)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1658 \n"); 
#ifdef CONFIG_IP_VS_NFCT
	enum ip_conntrack_info ctinfo;
	struct nf_conn *ct;
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ip_vs.h: line 1675 \n"); 
