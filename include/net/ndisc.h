...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ndisc.h: line 328 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ndisc.h: line 355 \n"); 
	u8 *lladdr = (u8 *)(p + 1);
...
static inline u8 *ndisc_opt_addr_data(struct nd_opt_hdr *p,
				      struct net_device *dev)
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ndisc.h: line 366 \n"); 
...
{
	if (kernel_init_done == 1) printk("We reached unpopular paths in include/net/ndisc.h: line 388 \n"); 
	struct neighbour *n;
